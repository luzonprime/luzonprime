...
export function WhatsAppButton() {
  ...
  // Property detail pages have their own sticky enquiry bar (with WhatsApp),
  // so the floating FAB would overlap the Enquire button — hide it there.
  const isPropertyDetail = pathname.startsWith("/listings/");
  if (!number || isPropertyDetail) return null;
